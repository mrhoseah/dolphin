...
func serve(cmd *cobra.Command, args []string) {
	...
	go func() {
		logger.Info("🚀 Dolphin server running", zap.String("url", address))
		logger.Info("📚 API Documentation", zap.String("url", fmt.Sprintf("%s/swagger/index.html", address)))
